...
module niosLab2_mm_interconnect_0 (
		...
		output wire [1:0]  DIR_s1_address,                                      //                                        DIR_s1.address
		input  wire [31:0] DIR_s1_readdata,                                     //                                              .readdata
	...
	wire   [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> pio_0_s1_agent:cp_channel
	...
	wire  [31:0] dir_s1_agent_m0_readdata;                                                           // DIR_s1_translator:uav_readdata -> DIR_s1_agent:m0_readdata
	wire         dir_s1_agent_m0_waitrequest;                                                        // DIR_s1_translator:uav_waitrequest -> DIR_s1_agent:m0_waitrequest
	wire         dir_s1_agent_m0_debugaccess;                                                        // DIR_s1_agent:m0_debugaccess -> DIR_s1_translator:uav_debugaccess
	wire  [19:0] dir_s1_agent_m0_address;                                                            // DIR_s1_agent:m0_address -> DIR_s1_translator:uav_address
	wire   [3:0] dir_s1_agent_m0_byteenable;                                                         // DIR_s1_agent:m0_byteenable -> DIR_s1_translator:uav_byteenable
	wire         dir_s1_agent_m0_read;                                                               // DIR_s1_agent:m0_read -> DIR_s1_translator:uav_read
	wire         dir_s1_agent_m0_readdatavalid;                                                      // DIR_s1_translator:uav_readdatavalid -> DIR_s1_agent:m0_readdatavalid
	wire         dir_s1_agent_m0_lock;                                                               // DIR_s1_agent:m0_lock -> DIR_s1_translator:uav_lock
	wire  [31:0] dir_s1_agent_m0_writedata;                                                          // DIR_s1_agent:m0_writedata -> DIR_s1_translator:uav_writedata
	wire         dir_s1_agent_m0_write;                                                              // DIR_s1_agent:m0_write -> DIR_s1_translator:uav_write
	wire   [2:0] dir_s1_agent_m0_burstcount;                                                         // DIR_s1_agent:m0_burstcount -> DIR_s1_translator:uav_burstcount
	wire         dir_s1_agent_rf_source_valid;                                                       // DIR_s1_agent:rf_source_valid -> DIR_s1_agent_rsp_fifo:in_valid
	wire  [96:0] dir_s1_agent_rf_source_data;                                                        // DIR_s1_agent:rf_source_data -> DIR_s1_agent_rsp_fifo:in_data
	wire         dir_s1_agent_rf_source_ready;                                                       // DIR_s1_agent_rsp_fifo:in_ready -> DIR_s1_agent:rf_source_ready
	wire         dir_s1_agent_rf_source_startofpacket;                                               // DIR_s1_agent:rf_source_startofpacket -> DIR_s1_agent_rsp_fifo:in_startofpacket
	wire         dir_s1_agent_rf_source_endofpacket;                                                 // DIR_s1_agent:rf_source_endofpacket -> DIR_s1_agent_rsp_fifo:in_endofpacket
	wire         dir_s1_agent_rsp_fifo_out_valid;                                                    // DIR_s1_agent_rsp_fifo:out_valid -> DIR_s1_agent:rf_sink_valid
	wire  [96:0] dir_s1_agent_rsp_fifo_out_data;                                                     // DIR_s1_agent_rsp_fifo:out_data -> DIR_s1_agent:rf_sink_data
	wire         dir_s1_agent_rsp_fifo_out_ready;                                                    // DIR_s1_agent:rf_sink_ready -> DIR_s1_agent_rsp_fifo:out_ready
	wire         dir_s1_agent_rsp_fifo_out_startofpacket;                                            // DIR_s1_agent_rsp_fifo:out_startofpacket -> DIR_s1_agent:rf_sink_startofpacket
	wire         dir_s1_agent_rsp_fifo_out_endofpacket;                                              // DIR_s1_agent_rsp_fifo:out_endofpacket -> DIR_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> DIR_s1_agent:cp_valid
	wire  [95:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> DIR_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // DIR_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> DIR_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> DIR_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> DIR_s1_agent:cp_endofpacket
	...
	wire  [19:0] en_s1_agent_m0_address;                                                             // EN_s1_agent:m0_address -> EN_s1_translator:uav_address
	...
	wire  [96:0] en_s1_agent_rf_source_data;                                                         // EN_s1_agent:rf_source_data -> EN_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] en_s1_agent_rsp_fifo_out_data;                                                      // EN_s1_agent_rsp_fifo:out_data -> EN_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> EN_s1_agent:cp_valid
	wire  [95:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> EN_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // EN_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> EN_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> EN_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> EN_s1_agent:cp_endofpacket
	...
	wire  [95:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [95:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> pio_1_s1_agent:cp_data
	...
	wire         dir_s1_agent_rp_valid;                                                              // DIR_s1_agent:rp_valid -> router_005:sink_valid
	wire  [95:0] dir_s1_agent_rp_data;                                                               // DIR_s1_agent:rp_data -> router_005:sink_data
	wire         dir_s1_agent_rp_ready;                                                              // router_005:sink_ready -> DIR_s1_agent:rp_ready
	wire         dir_s1_agent_rp_startofpacket;                                                      // DIR_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         dir_s1_agent_rp_endofpacket;                                                        // DIR_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         en_s1_agent_rp_valid;                                                               // EN_s1_agent:rp_valid -> router_006:sink_valid
	wire  [95:0] en_s1_agent_rp_data;                                                                // EN_s1_agent:rp_data -> router_006:sink_data
	wire         en_s1_agent_rp_ready;                                                               // router_006:sink_ready -> EN_s1_agent:rp_ready
	wire         en_s1_agent_rp_startofpacket;                                                       // EN_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         en_s1_agent_rp_endofpacket;                                                         // EN_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [95:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [95:0] pio_1_s1_agent_rp_data;                                                             // pio_1_s1_agent:rp_data -> router_008:sink_data
	...
	wire         dir_s1_agent_rdata_fifo_src_valid;                                                  // DIR_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] dir_s1_agent_rdata_fifo_src_data;                                                   // DIR_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         dir_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_003:in_0_ready -> DIR_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> DIR_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> DIR_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // DIR_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> DIR_s1_agent:rdata_fifo_sink_error
	wire         en_s1_agent_rdata_fifo_src_valid;                                                   // EN_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] en_s1_agent_rdata_fifo_src_data;                                                    // EN_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         en_s1_agent_rdata_fifo_src_ready;                                                   // avalon_st_adapter_004:in_0_ready -> EN_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> EN_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> EN_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // EN_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> EN_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (dir_s1_agent_m0_address),                        // avalon_universal_slave_0.address
		.uav_burstcount         (dir_s1_agent_m0_burstcount),                     //                         .burstcount
		.uav_read               (dir_s1_agent_m0_read),                           //                         .read
		.uav_write              (dir_s1_agent_m0_write),                          //                         .write
		.uav_waitrequest        (dir_s1_agent_m0_waitrequest),                    //                         .waitrequest
		.uav_readdatavalid      (dir_s1_agent_m0_readdatavalid),                  //                         .readdatavalid
		.uav_byteenable         (dir_s1_agent_m0_byteenable),                     //                         .byteenable
		.uav_readdata           (dir_s1_agent_m0_readdata),                       //                         .readdata
		.uav_writedata          (dir_s1_agent_m0_writedata),                      //                         .writedata
		.uav_lock               (dir_s1_agent_m0_lock),                           //                         .lock
		.uav_debugaccess        (dir_s1_agent_m0_debugaccess),                    //                         .debugaccess
		.av_address             (DIR_s1_address),                                 //      avalon_anti_slave_0.address
		.av_readdata            (DIR_s1_readdata),                                //                         .readdata
		.av_write               (),                                               //              (terminated)
		.av_read                (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (dir_s1_agent_m0_address),                        //              m0.address
		.m0_burstcount           (dir_s1_agent_m0_burstcount),                     //                .burstcount
		.m0_byteenable           (dir_s1_agent_m0_byteenable),                     //                .byteenable
		.m0_debugaccess          (dir_s1_agent_m0_debugaccess),                    //                .debugaccess
		.m0_lock                 (dir_s1_agent_m0_lock),                           //                .lock
		.m0_readdata             (dir_s1_agent_m0_readdata),                       //                .readdata
		.m0_readdatavalid        (dir_s1_agent_m0_readdatavalid),                  //                .readdatavalid
		.m0_read                 (dir_s1_agent_m0_read),                           //                .read
		.m0_waitrequest          (dir_s1_agent_m0_waitrequest),                    //                .waitrequest
		.m0_writedata            (dir_s1_agent_m0_writedata),                      //                .writedata
		.m0_write                (dir_s1_agent_m0_write),                          //                .write
		.rp_endofpacket          (dir_s1_agent_rp_endofpacket),                    //              rp.endofpacket
		.rp_ready                (dir_s1_agent_rp_ready),                          //                .ready
		.rp_valid                (dir_s1_agent_rp_valid),                          //                .valid
		.rp_data                 (dir_s1_agent_rp_data),                           //                .data
		.rp_startofpacket        (dir_s1_agent_rp_startofpacket),                  //                .startofpacket
		...
		.rf_sink_ready           (dir_s1_agent_rsp_fifo_out_ready),                //         rf_sink.ready
		.rf_sink_valid           (dir_s1_agent_rsp_fifo_out_valid),                //                .valid
		.rf_sink_startofpacket   (dir_s1_agent_rsp_fifo_out_startofpacket),        //                .startofpacket
		.rf_sink_endofpacket     (dir_s1_agent_rsp_fifo_out_endofpacket),          //                .endofpacket
		.rf_sink_data            (dir_s1_agent_rsp_fifo_out_data),                 //                .data
		.rf_source_ready         (dir_s1_agent_rf_source_ready),                   //       rf_source.ready
		.rf_source_valid         (dir_s1_agent_rf_source_valid),                   //                .valid
		.rf_source_startofpacket (dir_s1_agent_rf_source_startofpacket),           //                .startofpacket
		.rf_source_endofpacket   (dir_s1_agent_rf_source_endofpacket),             //                .endofpacket
		.rf_source_data          (dir_s1_agent_rf_source_data),                    //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),              //                .error
		.rdata_fifo_src_ready    (dir_s1_agent_rdata_fifo_src_ready),              //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (dir_s1_agent_rdata_fifo_src_valid),              //                .valid
		.rdata_fifo_src_data     (dir_s1_agent_rdata_fifo_src_data),               //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) dir_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (dir_s1_agent_rf_source_data),                    //        in.data
		.in_valid          (dir_s1_agent_rf_source_valid),                   //          .valid
		.in_ready          (dir_s1_agent_rf_source_ready),                   //          .ready
		.in_startofpacket  (dir_s1_agent_rf_source_startofpacket),           //          .startofpacket
		.in_endofpacket    (dir_s1_agent_rf_source_endofpacket),             //          .endofpacket
		.out_data          (dir_s1_agent_rsp_fifo_out_data),                 //       out.data
		.out_valid         (dir_s1_agent_rsp_fifo_out_valid),                //          .valid
		.out_ready         (dir_s1_agent_rsp_fifo_out_ready),                //          .ready
		.out_startofpacket (dir_s1_agent_rsp_fifo_out_startofpacket),        //          .startofpacket
		.out_endofpacket   (dir_s1_agent_rsp_fifo_out_endofpacket),          //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	niosLab2_mm_interconnect_0_router router_001 (
	...
	niosLab2_mm_interconnect_0_router_002 router_003 (
	...
	niosLab2_mm_interconnect_0_router_002 router_005 (
		.sink_ready         (dir_s1_agent_rp_ready),                          //      sink.ready
		.sink_valid         (dir_s1_agent_rp_valid),                          //          .valid
		.sink_data          (dir_s1_agent_rp_data),                           //          .data
		.sink_startofpacket (dir_s1_agent_rp_startofpacket),                  //          .startofpacket
		.sink_endofpacket   (dir_s1_agent_rp_endofpacket),                    //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_router_002 router_008 (
	...
	niosLab2_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (dir_s1_agent_rdata_fifo_src_data),               //     in_0.data
		.in_0_valid     (dir_s1_agent_rdata_fifo_src_valid),              //         .valid
		.in_0_ready     (dir_s1_agent_rdata_fifo_src_ready),              //         .ready
